#!/usr/bin/env python3
"""
Paket-Manager - Zentralisiertes Tracking für DHL, Hermes, GLS und DPD
Optimiert für Cron-Jobs mit JSON-Output und Telegram-Integration

Plugins: dhl_tracker.py, hermes_tracker.py, gls_tracker.py, dpd_tracker.py
"""
...
3. Bei Status-Änderung:
   ...
   - Format: '🚚 **DHL/HERMES/GLS/DPD UPDATE**\\n📦 [CODE]\\n✅ [STATUS]'
...
def add_new_package(tracking_code: str, carrier: str, description: str = '') -> bool:
    ...
    if carrier not in ['dhl', 'hermes', 'gls', 'dpd']:
...
def track_carrier(tracking_code: str, carrier: str, current_status: str) -> Dict[str, Any]:
    ...
    Args:
        ...
        carrier: 'dhl', 'hermes', 'gls' oder 'dpd'
    ...
    scripts = {
        ...
        'gls': str(Path(__file__).parent / 'gls_tracker.py'),
        'dpd': str(Path(__file__).parent / 'dpd_tracker.py')
    }
    
    timeouts = {'hermes': 120, 'dhl': 60, 'gls': 30, 'dpd': 60}
...
def main():
    ...
    parser.add_argument('--carrier', '-r', choices=['dhl', 'hermes', 'gls', 'dpd'])
