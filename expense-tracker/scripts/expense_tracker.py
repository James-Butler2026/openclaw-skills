#!/usr/bin/env python3
"""
Expense Tracker v3.0 - Komplettes Budget-Tracking
...
def main():
    parser = argparse.ArgumentParser(description="Expense Tracker v3.0 - Komplettes Budget-Tracking")
    ...
    parser.add_argument("--weekly", action="store_true", help="Aktuelle Kalenderwoche (Mo-So) mit Details")
    parser.add_argument("--last-week", action="store_true", help="Letzte Woche (Mo-So) mit Details")
    parser.add_argument("--month-to-date", action="store_true", help="Variable Ausgaben 1. bis heute mit Details")
    parser.add_argument("--monthly", action="store_true", help="Vollständiger Monatsbericht mit Budget")
    parser.add_argument("--full-month", action="store_true", help="Kompletter Monat (nur variabel, speichert Zusammenfassung)")
