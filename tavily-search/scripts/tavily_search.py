...
Euer Assistent für erstklassige Websuche.
...
def format_results(data: dict) -> str:
    ...
    if not results:
        lines.append("🎩 *Verbeugt sich bedauernd* Leider keine Ergebnisse gefunden, Euer.")
        return "\n".join(lines)
    ...
    lines.append("="*60)
    lines.append("🎩 Euer Assistent hat die Suche beendet.")
    lines.append("="*60 + "\n")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Tavily Websuche - Euer Assistent",
